...
\begin{figure}[b]
\centering
\includegraphics[width=14.217cm,height=9.929cm]{CIP_leonardo.jpg}
% \includepdf{cip_leonardo.pdf}
\end{figure}
...
\input{elementos-textuais/2-revisao-bibliografica}
\input{elementos-textuais/3-materiais-metodos}
\input{elementos-textuais/4-conclusao}
